...
//------------------------------------------------------------------------------
// Update tarif : https://particulier.edf.fr/fr/accueil/offres-d-energies-et-services/les-offres-d-energie/electricite.html
...
// Stats type
if(isset($aOptions['t']) || isset($aOptions['type']) || empty($aOptions)){
// TODO
}

// Stats of yesterday (default)
if(isset($aOptions['y']) || isset($aOptions['yesterday']) || empty($aOptions)){
...
// Stats for evey day or month between two dates
else if(
